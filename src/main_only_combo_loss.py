...
from train_only_combo_loss import training
            ...
            for i in range(1, k+1, 1):
                ...
                if i == 1:
                    weights_path = os.path.join(
                        '..', 'result', '2021-12-06 14-26-14_focal_GDL_constantLR_1e-4',
                        'fold 1', 'save_model', 'UNet-best.pkl')
                    model.model = load_weights(weights_path)
                    print(f'load weight from {weights_path}')
